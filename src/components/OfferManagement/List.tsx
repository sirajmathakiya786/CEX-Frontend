...
const OfferList = () => {
  ...
  return (
    <>
      ...
      <div className="container relative overflow-x-auto overflow-y-hidden shadow-md sm:rounded-lg">
          ...
          <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
              <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td className="px-6 py-4">03-04-2024</td>
                <td className="px-6 py-4">Hello this is demo offer</td>
                <td className="px-6 py-4">this is description for test</td>
